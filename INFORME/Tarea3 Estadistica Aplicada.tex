...
~\\ La prueba realizada fue de dos colas, por lo tanto, las hipotesis planteadas son del siguiente tipo:
\begin{center}
...
\end{center}
~\\El resultado de R nos arroja el p-valor, el cual fue $3.219*10^{-14}$ o lo que es lo mismo 0.00000000000003219, lo cuál es un valor p demasiado pequeño, que nos lleva a rechazar $H_{0}$ y concluimos que los residuales no son independientes, o que tienen una correlación entre ellos.
